    ...
    <br><br>
      ...
      <div class="row form-group">
        <div class="col col-md-2"><label for="text-input" class="form-control-label">Tanggal Pinjam</label></div>
          <div class="col-12 col-md-9"><input type="date" id="tgl_pinjam" name="tgl_pinjam"" class="form-control"></div>
      </div>
      <div class="row form-group">
       ...
       <button type="submit" class="btn btn-info center-block btn-block"><i class="fa fa-Search" style="font-style: 'bold'"> CARI</i> </button>
  </div>
